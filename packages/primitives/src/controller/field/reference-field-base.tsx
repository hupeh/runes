...
} from "./use-reference-field-controller";
 ...
 */
export const ReferenceFieldBase = <ReferenceRecordType extends Data = Data>(
	...
	return (
		<ResourceContextProvider value={props.reference}>
			<ReferenceFieldContextProvider value={controllerProps}>
				<DataContextProvider value={referenceRecord}>
					{shouldRenderLoading
						? loading
						: shouldRenderOffline
							? offline
...
export interface ReferenceFieldBaseProps<
	ReferenceRecordType extends Data = Data,
