...
>(
	...
	const getRecordRepresentation = useGetDataRepresentation(resource);
	...
	const defaultTitle = translate(`resources.${resource}.page.edit`, {
		...
		recordRepresentation:
			typeof recordRepresentation === "string" ? recordRepresentation : "",
...
export interface EditControllerBaseResult<RecordType extends Data = any>
...
export interface EditControllerLoadingResult<RecordType extends Data = any>
...
export interface EditControllerSuccessResult<RecordType extends Data = any>
	extends EditControllerBaseResult<RecordType> {
	record: RecordType;
	error: null;
	isPending: false;
