...
export const useChoicesContext = <ChoicesType extends Data = Data>(
	...
	const choices =
		options.choices && isArrayOfStrings(options.choices)
			...
			: options.choices;
	// @ts-expect-error cannot satisfy the type of useList because of ability to pass partial options
