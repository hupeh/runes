import { ResourceContextProvider, testDataProvider } from "@runes/core";
...
import { FormGroupContextProvider } from "./form-group-context-provider";
import { getFormGroupState, useFormGroup } from "./use-form-group";
...
describe("useFormGroup", () => {
	...
	it("should return the correct group state when the group changes", async () => {
		...
		const IsDirty = () => {
			...
			return (
				<button type="button" onClick={() => setGroup("simplegroup2")}>
					Change group
				</button>
			);
		};
